...
function InternalContainer(_a) {
  ...
  return import_react2.default.createElement(
    "div",
    Object.assign({}, baseProps, funnelSubStepProps, { className: clsx_m_default(baseProps.className, styles_css_default.root, styles_css_default[`variant-${variant}`], fitHeight && styles_css_default["fit-height"], hasMedia && (mediaPosition === "side" ? styles_css_default["with-side-media"] : styles_css_default["with-top-media"]), shouldHaveStickyStyles && [styles_css_default["sticky-enabled"]]), ref: mergedRef }),
    hasMedia && import_react2.default.createElement("div", { className: clsx_m_default(styles_css_default[`media-${mediaPosition === "side" ? "side" : "top"}`], styles_css_default.media), style: mediaPosition === "top" ? { height: (media === null || media === void 0 ? void 0 : media.height) || "" } : { width: (media === null || media === void 0 ? void 0 : media.width) || "" } }, media.content),
    import_react2.default.createElement(
      "div",
      { className: clsx_m_default(styles_css_default["content-wrapper"], fitHeight && styles_css_default["content-wrapper-fit-height"]) },
      header && import_react2.default.createElement(
        StickyHeaderContext.Provider,
        { value: { isStuck } },
        import_react2.default.createElement("div", Object.assign({ className: clsx_m_default(styles_css_default.header, styles_css_default[`header-variant-${variant}`], {
        ...
        }) }, headerIdProp, stickyStyles, { ref: headerMergedRef }), __darkHeader ? import_react2.default.createElement("div", { className: clsx_m_default(styles_css_default["dark-header"], "awsui-context-content-header") }, header) : header)
      ),
      import_react2.default.createElement("div", { className: clsx_m_default(styles_css_default.content, fitHeight && styles_css_default["content-fit-height"], {
        [styles_css_default["with-paddings"]]: !disableContentPaddings
      }) }, children),
      footer && import_react2.default.createElement("div", { className: clsx_m_default(styles_css_default.footer, {
...
//# sourceMappingURL=chunk-XF76KBF2.js.map
