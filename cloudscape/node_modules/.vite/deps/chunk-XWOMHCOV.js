...
var useVisualContext = function(elementRef) {
  ...
  var _a = (0, import_react.useState)(""), value = _a[0], setValue = _a[1];
  useMutationObserver(elementRef, function(node) {
    var contextParent = findUpUntil(node, function(node2) {
      return !!node2.className.match(contextMatch);
    });
...
function Portal(_a) {
  ...
  var _b = (0, import_react2.useState)(container !== null && container !== void 0 ? container : null), activeContainer = _b[0], setActiveContainer = _b[1];
...
function TabTrap(_a) {
  ...
  return import_react4.default.createElement("div", { tabIndex: disabled ? -1 : 0, onFocus: focusNextCallback });
}
...
function getFocusables(container) {
  return Array.prototype.slice.call(container.querySelectorAll(tabbables)).filter(function(element) {
...
var DropdownContainer = function(_a) {
  ...
  if (renderWithPortal) {
    if (open) {
      return (0, import_react_dom2.createPortal)(import_react5.default.createElement("div", { id }, children), document.body);
    } else {
      return null;
    }
  } else {
...
var TransitionContent = function(_a) {
  ...
  return import_react5.default.createElement(
    "div",
    { className: clsx_m_default(styles_css_default2.dropdown, dropdownClasses, (_b = {}, _b[styles_css_default2.open] = open, _b[styles_css_default2["with-limited-width"]] = !stretchWidth, _b[styles_css_default2["hide-upper-border"]] = stretchWidth, _b[styles_css_default2.interior] = interior, _b[styles_css_default2["is-empty"]] = !header && !children, _b[styles_css_default2.refresh] = isRefresh, _b[styles_css_default2["use-portal"]] = expandToViewport && !interior, _b)), ref: contentRef, "data-open": open, "data-animating": state !== "exited", "aria-hidden": !open, onMouseDown },
    import_react5.default.createElement(
      "div",
      { className: clsx_m_default(styles_css_default2["dropdown-content-wrapper"], isRefresh && styles_css_default2.refresh) },
      import_react5.default.createElement(
        "div",
        { className: styles_css_default2["ie11-wrapper"] },
        import_react5.default.createElement(
          "div",
...
var Dropdown = function(_a) {
  ...
  var dropdownContainerRef = (0, import_react5.useRef)(null);
  var verticalContainerRef = (0, import_react5.useRef)(null);
  var fixedPosition = (0, import_react5.useRef)(null);
  var isRefresh = useVisualRefresh();
  var dropdownClasses = usePortalModeClasses(triggerRef);
  var _l = (0, import_react5.useState)("bottom-right"), position = _l[0], setPosition = _l[1];
  ...
  var setDropdownPosition = function(position2, triggerBox, target, verticalContainer) {
    ...
    target.classList.add(position2.dropLeft ? styles_css_default2["dropdown-drop-left"] : styles_css_default2["dropdown-drop-right"]);
  ...
  return import_react5.default.createElement(
    ...
    import_react5.default.createElement("div", { className: clsx_m_default(stretchTriggerHeight && styles_css_default2["stretch-trigger-height"]), ref: triggerRef }, trigger),
    import_react5.default.createElement(TabTrap, { focusNextCallback: function() {
      var _a2;
    ...
    import_react5.default.createElement(
      ...
      import_react5.default.createElement(Transition, { "in": open !== null && open !== void 0 ? open : false, exit: false }, function(state, ref) {
        return import_react5.default.createElement(
          "div",
          ...
          import_react5.default.createElement(TransitionContent, { state, transitionRef: ref, dropdownClasses, open, stretchWidth, interior, header, expandToViewport, footer, onMouseDown, isRefresh, dropdownRef, verticalContainerRef, position }, children),
          import_react5.default.createElement(TabTrap, { focusNextCallback: function() {
            var _a2;
...
var Arrow = function(props) {
  return import_react6.default.createElement(
    ...
    import_react6.default.createElement("div", { className: styles_css_default4["arrow-outer"] }),
    import_react6.default.createElement("div", { className: styles_css_default4["arrow-inner"] })
  );
};
var arrow_default = import_react6.default.memo(Arrow);
...
function PopoverContainer(_a) {
  ...
  var bodyRef = (0, import_react7.useRef)(null);
  var contentRef = (0, import_react7.useRef)(null);
  var popoverRef = (0, import_react7.useRef)(null);
  var arrowRef = (0, import_react7.useRef)(null);
  var _c = (0, import_react7.useState)(INITIAL_STYLES), popoverStyle = _c[0], setPopoverStyle = _c[1];
  var _d = (0, import_react7.useState)(null), internalPosition = _d[0], setInternalPosition = _d[1];
  var isRefresh = useVisualRefresh();
  var positionHandlerRef = (0, import_react7.useRef)(function() {
  });
  var updatePositionHandler = (0, import_react7.useCallback)(function() {
  ...
  return import_react7.default.createElement(
    ...
    import_react7.default.createElement("div", { ref: arrowRef, className: clsx_m_default(styles_css_default4["container-arrow"], styles_css_default4["container-arrow-position-".concat(internalPosition)]), "aria-hidden": true }, arrow(internalPosition)),
    import_react7.default.createElement(
      ...
      import_react7.default.createElement("div", { ref: contentRef }, children)
    )
  );
}
...
function FocusLock(_a) {
  ...
  return import_react8.default.createElement(
    ...
    null,
    import_react8.default.createElement(TabTrap, { disabled, focusNextCallback: focusLast }),
    import_react8.default.createElement("div", { className, ref: containerRef }, children),
    import_react8.default.createElement(TabTrap, { disabled, focusNextCallback: focusFirst })
  );
}
...
function PopoverBody(_a) {
  ...
  var dismissButtonFocused = (0, import_react9.useRef)(false);
  var dismissButtonRef = (0, import_react9.useRef)(null);
  ...
  var dismissButton = (showDismissButton !== null && showDismissButton !== void 0 ? showDismissButton : null) && import_react9.default.createElement(
    "div",
    { className: styles_css_default4.dismiss },
    import_react9.default.createElement(InternalButton, { variant: "icon", formAction: "none", iconName: "close", className: styles_css_default4["dismiss-control"], ariaLabel: dismissAriaLabel, onClick: function() {
      return onDismiss();
  ...
  return import_react9.default.createElement(
    ...
    import_react9.default.createElement(
      ...
      header && import_react9.default.createElement(
        "div",
        ...
        import_react9.default.createElement(
          ...
          import_react9.default.createElement("h2", null, header)
        )
      ),
      import_react9.default.createElement(
        "div",
        ...
        import_react9.default.createElement("div", { className: clsx_m_default(styles_css_default4.content, (_c = {}, _c[styles_css_default4["content-overflow-visible"]] = !!overflowVisible, _c)) }, children)
      )
    )
  );
}
...
function Tooltip(_a) {
  ...
  return import_react10.default.createElement(
    ...
    children,
    open && import_react10.default.createElement(
      Portal,
      null,
      import_react10.default.createElement(
        ...
        import_react10.default.createElement(
          ...
          { size: "small", fixedWidth: false, position, trackRef: ref, arrow: function(position2) {
            return import_react10.default.createElement(arrow_default, { position: position2 });
          }, renderWithPortal: true, zIndex: 7e3 },
          import_react10.default.createElement(
            PopoverBody,
            { dismissButton: false, dismissAriaLabel: void 0, header: null, onDismiss: function() {
            }, overflowVisible: "both" },
            import_react10.default.createElement("span", { "data-testid": "button-dropdown-disabled-reason", role: "tooltip" }, content)
          )
        )
      )
    )
...
function useTooltipOpen(timeout) {
  var handle = (0, import_react10.useRef)();
  var _a = (0, import_react10.useState)(false), isOpen = _a[0], setIsOpen = _a[1];
  var close = function() {
...
function useHiddenDescription(description) {
  ...
  return {
    ...
    descriptionEl: description ? import_react11.default.createElement("span", { id, hidden: true }, description) : null
  };
}
...
var ItemElement = function(_a) {
  ...
  return import_react12.default.createElement(
    ...
    import_react12.default.createElement(MenuItem, { item, disabled, highlighted })
  );
};
function MenuItem(_a) {
  var item = _a.item, disabled = _a.disabled, highlighted = _a.highlighted;
  var menuItemRef = (0, import_react12.useRef)(null);
  ...
  var menuItem = isLinkItem(item) ? import_react12.default.createElement(
    "a",
    ...
    import_react12.default.createElement(MenuItemContent, { item, disabled })
  ...
  return isDisabledWithReason ? import_react12.default.createElement(
    Tooltip,
...
var MenuItemContent = function(_a) {
  ...
  return import_react12.default.createElement(
    ...
    null,
    hasIcon && import_react12.default.createElement(MenuItemIcon, { name: item.iconName, url: item.iconUrl, svg: item.iconSvg, alt: item.iconAlt }),
    " ",
    item.text,
    " ",
    hasExternal && import_react12.default.createElement(ExternalIcon, { disabled, ariaLabel: item.externalIconAriaLabel })
  );
};
var MenuItemIcon = function(props) {
  return import_react12.default.createElement(
    ...
    import_react12.default.createElement(internal_default, __assign({}, props))
  );
};
var ExternalIcon = function(_a) {
  var disabled = _a.disabled, ariaLabel = _a.ariaLabel;
  var icon = import_react12.default.createElement(internal_default, { variant: disabled ? "disabled" : "normal", name: "external" });
  return import_react12.default.createElement("span", { className: styles_css_default3["external-icon"], role: ariaLabel ? "img" : void 0, "aria-label": ariaLabel }, icon);
};
...
var ExpandableCategoryElement = function(_a) {
  ...
  var triggerRef = import_react13.default.useRef(null);
  ...
  var trigger = item.text && import_react13.default.createElement(
    "span",
    __assign({
    ...
    import_react13.default.createElement(
      ...
      import_react13.default.createElement(internal_default, { name: "caret-down-filled" })
    )
  );
  var content;
  if (isDisabledWithReason) {
    content = import_react13.default.createElement(
      Tooltip,
    ...
    content = import_react13.default.createElement(dropdown_default, { open: expanded, stretchWidth: false, interior: true, expandToViewport, trigger }, item.items && expanded && import_react13.default.createElement(
      "ul",
      { role: "menu", "aria-label": item.text, className: clsx_m_default(styles_css_default5["items-list-container"]) },
      import_react13.default.createElement(ItemsList, { items: item.items, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, highlightItem, variant })
    ));
  }
  return import_react13.default.createElement("li", { className: clsx_m_default(styles_css_default5.category, styles_css_default5["variant-".concat(variant)], styles_css_default5.expandable, (_c = {}, _c[styles_css_default5.expanded] = expanded, _c[styles_css_default5.disabled] = disabled, _c[styles_css_default5.highlighted] = highlighted, _c)), role: "presentation", "data-testid": item.id, ref, onClick, onMouseEnter: onHover, onTouchStart: onHover }, content);
};
...
var CategoryElement = function(_a) {
  ...
  return import_react14.default.createElement(
    ...
    item.text && import_react14.default.createElement("p", { className: clsx_m_default(styles_css_default5.header, (_b = {}, _b[styles_css_default5.disabled] = disabled, _b)), "aria-hidden": "true" }, item.text),
    import_react14.default.createElement("ul", { className: clsx_m_default(styles_css_default5["items-list-container"]), role: "group", "aria-label": item.text }, item.items && import_react14.default.createElement(ItemsList, { items: item.items, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, highlightItem, categoryDisabled: disabled, hasCategoryHeader: !!item.text, variant }))
  );
};
...
var MobileExpandableGroup = function(_a) {
  ...
  return import_react15.default.createElement(
    ...
    import_react15.default.createElement("div", { className: styles_css_default6.trigger }, trigger),
    import_react15.default.createElement("div", { className: clsx_m_default(styles_css_default6.dropdown, (_b = {}, _b[styles_css_default6.open] = open, _b)), "data-open": open }, children)
  );
};
...
var MobileExpandableCategoryElement = function(_a) {
  ...
  var expanded = isExpanded(item);
  var isKeyboardHighlighted = isKeyboardHighlight(item);
  var triggerRef = import_react16.default.useRef(null);
  ...
  var trigger = item.text && import_react16.default.createElement(
    "span",
    __assign({
    ...
    import_react16.default.createElement(
      ...
      import_react16.default.createElement(internal_default, { name: "caret-down-filled" })
    )
  );
  var content;
  if (isDisabledWithReason) {
    content = import_react16.default.createElement(
      import_react16.default.Fragment,
      null,
      descriptionEl,
      import_react16.default.createElement(Tooltip, { content: item.disabledReason }, trigger)
    );
  } else if (disabled) {
    content = trigger;
  } else {
    content = import_react16.default.createElement(mobile_expandable_group_default, { open: expanded, trigger }, item.items && expanded && import_react16.default.createElement(
      "ul",
      { role: "menu", "aria-label": item.text, className: clsx_m_default(styles_css_default5["items-list-container"]) },
      import_react16.default.createElement(ItemsList, { items: item.items, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, highlightItem, hasCategoryHeader: true, variant })
    ));
  }
  return import_react16.default.createElement("li", { className: clsx_m_default(styles_css_default5.category, styles_css_default5["variant-".concat(variant)], styles_css_default5.expandable, (_d = {}, _d[styles_css_default5.expanded] = expanded, _d[styles_css_default5.disabled] = disabled, _d[styles_css_default5.highlighted] = highlighted || expanded, _d[styles_css_default5.expandable] = true, _d)), role: "presentation", onClick, onMouseEnter: onHover, onTouchStart: onHover, "data-testid": item.id }, content);
};
...
function ItemsList(_a) {
  ...
  var elements = items.map(function(item, index) {
    var _a2, _b2, _c2, _d2;
    if (!isItemGroup(item)) {
      return import_react17.default.createElement(item_element_default, { key: index, item, onItemActivate, disabled: (_a2 = item.disabled) !== null && _a2 !== void 0 ? _a2 : categoryDisabled, highlighted: isHighlighted(item), isKeyboardHighlighted: isKeyboardHighlight(item), highlightItem, first: index === 0 || isItemGroup(items[index - 1]), last: index === items.length - 1 || isItemGroup(items[index + 1]), hasCategoryHeader, variant });
    }
    if (hasExpandableGroups) {
      return item.text ? isMobile ? import_react17.default.createElement(mobile_expandable_category_element_default, { key: index, item, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, highlightItem, disabled: (_b2 = item.disabled) !== null && _b2 !== void 0 ? _b2 : false, variant }) : import_react17.default.createElement(expandable_category_element_default, { key: index, item, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, highlightItem, disabled: (_c2 = item.disabled) !== null && _c2 !== void 0 ? _c2 : false, expandToViewport, variant }) : null;
    }
    return import_react17.default.createElement(category_element_default, { key: index, item, onItemActivate, onGroupToggle, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, highlightItem, disabled: (_d2 = item.disabled) !== null && _d2 !== void 0 ? _d2 : false, variant });
  });
  return import_react17.default.createElement(import_react17.default.Fragment, null, elements);
}
...
var useOpenState = function(_a) {
  ...
  var _b = (0, import_react18.useState)(false), isOpen = _b[0], setIsOpen = _b[1];
...
function useHighlightedMenu(_a) {
  ...
  var _c = (0, import_react19.useState)([]), targetIndex = _c[0], setTargetIndex = _c[1];
  var _d = (0, import_react19.useState)([]), expandedIndex = _d[0], setExpandedIndex = _d[1];
  var _e = (0, import_react19.useState)(true), isUsingMouse = _e[0], setIsUsingMouse = _e[1];
  var _f = (0, import_react19.useMemo)(function() {
  ...
  var highlightItem = (0, import_react19.useCallback)(function(item) {
    setTargetIndex(getItemIndex2(item));
  }, [getItemIndex2]);
  var expandGroup = (0, import_react19.useCallback)(function(group) {
  ...
  var collapseGroup = (0, import_react19.useCallback)(function() {
...
var OptionsList = function(_a, ref) {
  ...
  var menuRef = (0, import_react20.useRef)(null);
  ...
  return import_react20.default.createElement("ul", __assign({}, baseProps, nativeAttributes, { className, ref: mergedRef, style: { position }, role, onScroll: handleScroll, onKeyDown: function(event) {
...
var options_list_default = import_react20.default.forwardRef(OptionsList);

// node_modules/@cloudscape-design/components/button-dropdown/internal.js
var InternalButtonDropdown = import_react21.default.forwardRef(function(_a, ref) {
  ...
  var dropdownRef = (0, import_react21.useRef)(null);
  ...
  var trigger = customTriggerBuilder ? customTriggerBuilder(clickHandler, dropdownRef, disabled, isOpen, ariaLabel) : import_react21.default.createElement(InternalButton, __assign({ ref: dropdownRef }, iconProps, { variant: triggerVariant, loading, loadingText, disabled, onClick: function(event) {
    event.preventDefault();
    clickHandler();
  ...
  return import_react21.default.createElement(
    "div",
    __assign({}, baseProps, { onKeyDown, onKeyUp, onMouseDown: handleMouseEvent, onMouseMove: handleMouseEvent, className: clsx_m_default(styles_css_default["button-dropdown"], styles_css_default["variant-".concat(variant)], baseProps.className), "aria-owns": expandToViewport && isOpen ? dropdownId : void 0, ref: __internalRootRef }),
    import_react21.default.createElement(
      ...
      hasHeader && import_react21.default.createElement(
        ...
        title && import_react21.default.createElement(
          ...
          import_react21.default.createElement("span", { className: styles_css_default.title }, title)
        ),
        description && import_react21.default.createElement(
          InternalBox,
          { fontSize: "body-s" },
          import_react21.default.createElement("span", { className: styles_css_default.description }, description)
        )
      ),
      import_react21.default.createElement(
        ...
        import_react21.default.createElement(ItemsList, { items, onItemActivate, onGroupToggle, hasExpandableGroups: expandableGroups, targetItem, isHighlighted, isKeyboardHighlight, isExpanded, highlightItem, expandToViewport, variant })
      )
    )
  );
});
...
//# sourceMappingURL=chunk-XWOMHCOV.js.map
