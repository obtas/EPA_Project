...
// node_modules/@cloudscape-design/components/internal/logging.js
var messageCache = {};
...
var InternalIcon = function(_a) {
  ...
  var iconRef = (0, import_react2.useRef)(null);
  useVisualRefresh();
  var _e = (0, import_react2.useState)(null), parentHeight = _e[0], setParentHeight = _e[1];
  ...
  baseProps.className = clsx_m_default(baseProps.className, styles_css_default.icon, contextualSize && styles_css_default["icon-flex-height"], badge && styles_css_default.badge, !contextualSize && styles_css_default["size-".concat(iconSize, "-mapped-height")], styles_css_default["size-".concat(iconSize)], styles_css_default["variant-".concat(variant)]);
  ...
  if (svg) {
    ...
    return import_react2.default.createElement("span", __assign({}, baseProps, { ref: mergedRef, "aria-hidden": "true", style: inlineStyles }), svg);
  }
  if (url) {
    return import_react2.default.createElement(
      "span",
      __assign({}, baseProps, { ref: mergedRef, style: inlineStyles }),
      import_react2.default.createElement("img", { src: url, alt })
    );
  }
  var validIcon = name && Object.prototype.hasOwnProperty.call(icons_default, name);
  return import_react2.default.createElement("span", __assign({}, baseProps, {
...
//# sourceMappingURL=chunk-3AAOFNJY.js.map
