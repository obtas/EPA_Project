...
function useSelector(store, selector) {
  const [state, setState] = (0, import_react7.useState)(selector(store.get()));
  ...
  return import_react9.default.createElement(
    ...
    import_react9.default.createElement(
      ...
      import_react9.default.createElement(
        ...
        column.header,
        isEditable ? import_react9.default.createElement(
          "span",
          ...
          import_react9.default.createElement(internal_default, { name: "edit" })
        ) : null
      ),
      sortingStatus && import_react9.default.createElement(
        "span",
        { className: styles_css_default3["sorting-icon"] },
        import_react9.default.createElement(internal_default, { name: getSortingIconName(sortingStatus) })
      )
    ),
    resizableColumns && import_react9.default.createElement(
      import_react9.default.Fragment,
      null,
      import_react9.default.createElement(Resizer, { tabIndex, showFocusRing: (focusedComponent === null || focusedComponent === void 0 ? void 0 : focusedComponent.type) === "resizer" && focusedComponent.col === colIndex, onDragMove: (newWidth) => updateColumn(columnId, newWidth), onFinish: onResizeFinish, ariaLabelledby: headerId, onFocus: () => onFocusedComponentChange === null || onFocusedComponentChange === void 0 ? void 0 : onFocusedComponentChange({ type: "resizer", col: colIndex }), onBlur: () => onFocusedComponentChange === null || onFocusedComponentChange === void 0 ? void 0 : onFocusedComponentChange(null), minWidth: typeof column.minWidth === "string" ? parseInt(column.minWidth) : column.minWidth })
    )
  );
}

// node_modules/@cloudscape-design/components/table/thead.js
var Thead = import_react10.default.forwardRef(({ containerWidth, selectionType, getSelectAllProps, columnDefinitions, sortingColumn, sortingDisabled, sortingDescending, resizableColumns, variant, wrapLines, onFocusMove, onSortingChange, onResizeFinish, singleSelectionHeaderAriaLabel, stripedRows, sticky = false, hidden = false, stuck = false, stickyState, selectionColumnId: selectionColumnId2, focusedComponent, onFocusedComponentChange }, outerRef) => {
  ...
  return import_react10.default.createElement(
    ...
    import_react10.default.createElement(
      ...
      selectionType ? import_react10.default.createElement("th", { className: clsx_m_default(headerCellClass, selectionCellClass, hidden && styles_css_default3["header-cell-hidden"], stickyStyles.className), style: stickyStyles.style, ref: stickyStyles.ref, scope: "col" }, selectionType === "multi" ? import_react10.default.createElement(SelectionControl, Object.assign({ onFocusDown: (event) => {
        onFocusMove(event.target, -1, 1);
      }, focusedComponent, onFocusedComponentChange }, getSelectAllProps(), sticky ? { tabIndex: -1 } : {})) : import_react10.default.createElement(ScreenreaderOnly, null, singleSelectionHeaderAriaLabel)) : null,
      columnDefinitions.map((column, colIndex) => {
        ...
        return import_react10.default.createElement(TableHeaderCell, { key: columnId, className: headerCellClass, style: {
...
var TableTdElement = import_react11.default.forwardRef(({ className, style, children, wrapLines, isRowHeader, isFirstRow, isLastRow, isSelected, isNextSelected, isPrevSelected, nativeAttributes, onClick, onMouseEnter, onMouseLeave, isEvenRow, stripedRows, isVisualRefresh, hasSelection, hasFooter, columnId, stickyState }, ref) => {
  let Element = "td";
  if (isRowHeader) {
    Element = "th";
...
function useClickAway(onClick) {
  const awayRef = (0, import_react12.useRef)(null);
          ...
          import_react13.default.createElement(
            ...
            import_react13.default.createElement(
              ...
              import_react13.default.createElement(
                ...
                !currentEditLoading ? import_react13.default.createElement(internal_default2, { ariaLabel: (_b = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.cancelEditLabel) === null || _b === void 0 ? void 0 : _b.call(ariaLabels, column), formAction: "none", iconName: "close", variant: "inline-icon", onClick: onCancel }) : null,
                import_react13.default.createElement(internal_default2, { ariaLabel: (_c = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.submitEditLabel) === null || _c === void 0 ? void 0 : _c.call(ariaLabels, column), formAction: "submit", iconName: "check", variant: "inline-icon", loading: currentEditLoading })
              ),
              import_react13.default.createElement(live_region_default, null, currentEditLoading ? i18n("ariaLabels.submittingEditText", (_d = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.submittingEditText) === null || _d === void 0 ? void 0 : _d.call(ariaLabels, column)) : "")
            )
          )
        )
      )
...
function TableCellEditable(_a) {
  ...
  return import_react14.default.createElement(TableTdElement, Object.assign({}, rest, { nativeAttributes: tdNativeAttributes, className: clsx_m_default(className, styles_css_default5["body-cell-editable"], isEditing && styles_css_default5["body-cell-edit-active"], successfulEdit && styles_css_default5["body-cell-has-success"], isVisualRefresh && styles_css_default5["is-visual-refresh"]), onClick: !isEditing ? onEditStart : void 0, onMouseEnter: () => setHasHover(true), onMouseLeave: () => setHasHover(false) }), isEditing ? import_react14.default.createElement(InlineEditor, { ariaLabels, column, item, onEditEnd: (e) => {
    ...
    null,
    column.cell(item),
    successfulEdit && import_react14.default.createElement(
      import_react14.default.Fragment,
      null,
      import_react14.default.createElement(
        ...
        import_react14.default.createElement(internal_default, { name: "status-positive", variant: "success" })
      ),
      import_react14.default.createElement(live_region_default, null, i18n("ariaLabels.successfulEditLabel", (_c = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.successfulEditLabel) === null || _c === void 0 ? void 0 : _c.call(ariaLabels, column)))
    ),
    import_react14.default.createElement("button", { className: styles_css_default5["body-cell-editor"], "aria-label": (_d = ariaLabels === null || ariaLabels === void 0 ? void 0 : ariaLabels.activateEditLabel) === null || _d === void 0 ? void 0 : _d.call(ariaLabels, column, item), ref: editActivateRef, onFocus: () => setHasFocus(true), onBlur: () => setHasFocus(false) }, showIcon && import_react14.default.createElement(internal_default, { name: "edit" }))
  ));
}
function TableBodyCell(_a) {
  var { isEditable } = _a, rest = __rest(_a, ["isEditable"]);
  if (isEditable || rest.isEditing) {
    return import_react14.default.createElement(TableCellEditable, Object.assign({}, rest));
  }
  const { column, item } = rest;
  return import_react14.default.createElement(TableTdElement, Object.assign({}, rest), column.cell(item));
}
...
function useScrollSync(refs, disabled = !supportsStickyPosition()) {
  const activeElement = (0, import_react15.useRef)(null);
...
var useStickyHeader = (tableRef, theadRef, secondaryTheadRef, secondaryTableRef, tableWrapperRef) => {
  ...
  const syncColumnHeaderWidths = (0, import_react16.useCallback)(() => {
...
// node_modules/@cloudscape-design/components/table/sticky-header.js
var sticky_header_default = (0, import_react17.forwardRef)(StickyHeader);
function StickyHeader({ variant, theadProps, wrapperRef, theadRef, secondaryWrapperRef, onScroll, tableRef, tableHasHeader, contentDensity }, ref) {
  const secondaryTheadRef = (0, import_react17.useRef)(null);
  const secondaryTableRef = (0, import_react17.useRef)(null);
  const { isStuck } = (0, import_react17.useContext)(StickyHeaderContext);
  const [focusedComponent, setFocusedComponent] = (0, import_react17.useState)(null);
  ...
  return import_react17.default.createElement(
    ...
    import_react17.default.createElement(
      ...
      import_react17.default.createElement(thead_default, Object.assign({ ref: secondaryTheadRef, sticky: true, stuck: isStuck, focusedComponent }, theadProps))
    )
  );
}
...
function useMouseDownTarget() {
  const mouseDownTargetRef = (0, import_react18.useRef)(null);
...
function useTableFocusNavigation(selectionType, tableRoot, columnDefinitions, numRows) {
  const focusableColumns = (0, import_react19.useMemo)(() => {
  ...
  const focusCell = (0, import_react19.useCallback)((rowIndex, columnIndex) => {
  ...
  const shiftFocus = (0, import_react19.useCallback)((vertical, horizontal) => {
    var _a;
  ...
  const handleArrowKeyEvents = (0, import_react19.useCallback)((event) => {
    var _a, _b;
...
import "/local/home/samilafo/final_epa_project/QwizGuruPlatform/cloudscape/node_modules/@cloudscape-design/components/table/sticky-scrollbar/styles.scoped.css";
...
function useStickyScrollbar(scrollbarRef, scrollbarContentRef, tableRef, wrapperRef, footerHeight) {
  const [hasContainingBlock, setHasContainingBlock] = (0, import_react20.useState)(false);
  const [hasOverflowParent, setHasOverflowParent] = (0, import_react20.useState)(false);
...
// node_modules/@cloudscape-design/components/table/sticky-scrollbar/sticky-scrollbar.js
var sticky_scrollbar_default = (0, import_react21.forwardRef)(StickyScrollbar);
function StickyScrollbar({ wrapperRef, tableRef, onScroll }, ref) {
  const scrollbarRef = import_react21.default.useRef(null);
  const scrollbarContentRef = import_react21.default.useRef(null);
  ...
  return import_react21.default.createElement(
    ...
    import_react21.default.createElement("div", { ref: scrollbarContentRef, className: styles_css_default6["sticky-scrollbar-content"] })
  );
}
...
var InternalTable = import_react22.default.forwardRef((_a, ref) => {
  var _b, _c, _d;
  ...
  const wrapperRefObject = (0, import_react22.useRef)(null);
  const [tableWidth, tableMeasureRef] = useContainerQuery(({ width }) => width);
  const tableRefObject = (0, import_react22.useRef)(null);
  const secondaryWrapperRef = import_react22.default.useRef(null);
  const theadRef = (0, import_react22.useRef)(null);
  const stickyHeaderRef = import_react22.default.useRef(null);
  const scrollbarRef = import_react22.default.useRef(null);
  const [currentEditCell, setCurrentEditCell] = (0, import_react22.useState)(null);
  const [lastSuccessfulEditCell, setLastSuccessfulEditCell] = (0, import_react22.useState)(null);
  ...
  const toolsHeaderWrapper = (0, import_react22.useRef)(null);
  ...
  return import_react22.default.createElement(
    ...
    import_react22.default.createElement(
      InternalContainer,
      Object.assign({}, baseProps, { __internalRootRef, className: clsx_m_default(baseProps.className, styles_css_default.root), header: import_react22.default.createElement(
        import_react22.default.Fragment,
        null,
        hasHeader && import_react22.default.createElement(
          "div",
          ...
          import_react22.default.createElement(
            ...
            import_react22.default.createElement(ToolsHeader, { header, filter, pagination, preferences })
          )
        ),
        stickyHeader && import_react22.default.createElement(sticky_header_default, { ref: stickyHeaderRef, variant: computedVariant, theadProps, wrapperRef: wrapperRefObject, theadRef, secondaryWrapperRef, tableRef: tableRefObject, onScroll: handleScroll, tableHasHeader: hasHeader, contentDensity })
      ), disableHeaderPaddings: true, disableContentPaddings: true, variant: toContainerVariant(computedVariant), __disableFooterPaddings: true, __disableFooterDivider: true, __disableStickyMobile: false, footer: hasFooter ? import_react22.default.createElement(
        "div",
        ...
        import_react22.default.createElement(
          ...
          footer && import_react22.default.createElement("span", null, footer),
          hasFooterPagination && import_react22.default.createElement("div", { className: styles_css_default["footer-pagination"] }, pagination)
        )
      ...
      import_react22.default.createElement(
        ...
        !!renderAriaLive && !!firstIndex && import_react22.default.createElement(
          live_region_default,
          null,
          import_react22.default.createElement("span", null, renderAriaLive({ totalItemsCount, firstIndex, lastIndex: firstIndex + items.length - 1 }))
        ),
        import_react22.default.createElement(
          "table",
          {
          ...
          import_react22.default.createElement(thead_default, Object.assign({ ref: theadRef, hidden: stickyHeader, onFocusedComponentChange: (component) => {
            var _a2;
            return (_a2 = stickyHeaderRef.current) === null || _a2 === void 0 ? void 0 : _a2.setFocus(component);
          } }, theadProps)),
          import_react22.default.createElement("tbody", null, loading || items.length === 0 ? import_react22.default.createElement(
            "tr",
            null,
            import_react22.default.createElement(
              "td",
              ...
              import_react22.default.createElement("div", { className: styles_css_default["cell-merged-content"], style: {
                width: supportsStickyPosition() && containerWidth && Math.floor(containerWidth) || void 0
              } }, loading ? import_react22.default.createElement(
                StatusIndicator,
                { type: "loading", className: styles_css_default.loading, wrapText: true },
                import_react22.default.createElement(live_region_default, { visible: true }, loadingText)
              ) : import_react22.default.createElement("div", { className: styles_css_default.empty }, empty))
            )
            ...
            return import_react22.default.createElement(
              ...
              selectionType !== void 0 && import_react22.default.createElement(
                TableTdElement,
                ...
                import_react22.default.createElement(SelectionControl, Object.assign({ onFocusDown: moveFocusDown, onFocusUp: moveFocusUp, onShiftToggle: updateShiftToggle }, getItemSelectionProps(item)))
              ),
              visibleColumnDefinitions.map((column, colIndex) => {
                ...
                return import_react22.default.createElement(TableBodyCell, { key: getColumnKey(column, colIndex), style: resizableColumns ? {} : {
                  width: column.width,
        ...
        resizableColumns && import_react22.default.createElement(ResizeTracker, null)
      ),
      import_react22.default.createElement(sticky_scrollbar_default, { ref: scrollbarRef, wrapperRef: wrapperRefObject, tableRef: tableRefObject, onScroll: handleScroll })
    )
  );
});
...
// node_modules/@cloudscape-design/components/table/index.js
var Table = import_react23.default.forwardRef((_a, ref) => {
  ...
  return import_react23.default.createElement(internal_default4, Object.assign({ items, selectedItems, variant, contentDensity }, props, baseComponentProps, { ref }));
});
...
//# sourceMappingURL=chunk-R6QKTMJH.js.map
