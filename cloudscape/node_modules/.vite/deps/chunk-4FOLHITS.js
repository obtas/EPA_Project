...
import "/local/home/samilafo/final_epa_project/QwizGuruPlatform/cloudscape/node_modules/@cloudscape-design/components/icon/styles.scoped.css";
var styles_css_default = {
  "icon": "awsui_icon_h11ix_ttpon_98",
  "icon-flex-height": "awsui_icon-flex-height_h11ix_ttpon_104",
  "size-small": "awsui_size-small_h11ix_ttpon_129",
  "size-small-mapped-height": "awsui_size-small-mapped-height_h11ix_ttpon_133",
  "size-normal": "awsui_size-normal_h11ix_ttpon_147",
  "size-normal-mapped-height": "awsui_size-normal-mapped-height_h11ix_ttpon_151",
  "size-medium": "awsui_size-medium_h11ix_ttpon_165",
  "size-medium-mapped-height": "awsui_size-medium-mapped-height_h11ix_ttpon_169",
  "size-big": "awsui_size-big_h11ix_ttpon_183",
  "size-big-mapped-height": "awsui_size-big-mapped-height_h11ix_ttpon_187",
  "size-large": "awsui_size-large_h11ix_ttpon_201",
  "size-large-mapped-height": "awsui_size-large-mapped-height_h11ix_ttpon_205",
  "variant-normal": "awsui_variant-normal_h11ix_ttpon_219",
  "variant-disabled": "awsui_variant-disabled_h11ix_ttpon_222",
  "variant-inverted": "awsui_variant-inverted_h11ix_ttpon_225",
  "variant-subtle": "awsui_variant-subtle_h11ix_ttpon_228",
  "variant-warning": "awsui_variant-warning_h11ix_ttpon_231",
  "variant-error": "awsui_variant-error_h11ix_ttpon_234",
  "variant-success": "awsui_variant-success_h11ix_ttpon_237",
  "variant-link": "awsui_variant-link_h11ix_ttpon_240",
  "badge": "awsui_badge_h11ix_ttpon_244"
};
...
var InternalIcon = (_a) => {
  ...
  baseProps.className = clsx_m_default(baseProps.className, styles_css_default.icon, contextualSize && styles_css_default["icon-flex-height"], badge && styles_css_default.badge, !contextualSize && styles_css_default[`size-${iconSize}-mapped-height`], styles_css_default[`size-${iconSize}`], styles_css_default[`variant-${variant}`]);
  ...
  if (svg) {
    ...
    return import_react2.default.createElement("span", Object.assign({}, baseProps, { ref: mergedRef, "aria-hidden": "true", style: inlineStyles }), svg);
  }
  if (url) {
    return import_react2.default.createElement(
      "span",
      Object.assign({}, baseProps, { ref: mergedRef, style: inlineStyles }),
      import_react2.default.createElement("img", { src: url, alt })
    );
  }
  const validIcon = name && Object.prototype.hasOwnProperty.call(icons_default, name);
  return import_react2.default.createElement("span", Object.assign({}, baseProps, {
    dangerouslySetInnerHTML: validIcon ? { __html: icons_default[name] } : void 0,
    ref: mergedRef,
    style: inlineStyles
  }));
};
...
//# sourceMappingURL=chunk-4FOLHITS.js.map
