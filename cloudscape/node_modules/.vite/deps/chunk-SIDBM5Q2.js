...
function Transition2(_a) {
  var isIn = _a["in"], children2 = _a.children, _b = _a.exit, exit = _b === void 0 ? true : _b, _c = _a.onStatusChange, onStatusChange = _c === void 0 ? function() {
    return void 0;
  } : _c, _d = _a.disabled, disabled = _d === void 0 ? false : _d, transitionChangeDelay = _a.transitionChangeDelay, rest = __rest(_a, ["in", "children", "exit", "onStatusChange", "disabled", "transitionChangeDelay"]);
  var transitionRootElement = (0, import_react11.useRef)(null);
  var _e = (0, import_react10.useState)(isIn ? "entered" : "exited"), transitionState = _e[0], setTransitionState = _e[1];
  var motionDisabled = useReducedMotion(transitionRootElement) || disabled;
  var addTransitionEndListener = (0, import_react11.useCallback)(function(done) {
  ...
  return import_react10.default.createElement(Transition_default, __assign({ addEndListener: addTransitionEndListener, timeout: motionDisabled ? 0 : void 0, "in": isIn, nodeRef: transitionRootElement, exit, onEnter: function(isAppearing) {
    if (!isAppearing) {
    ...
    return children2(transitionState, transitionRootElement);
  });
}
...
@license MIT
*/
//# sourceMappingURL=chunk-SIDBM5Q2.js.map
