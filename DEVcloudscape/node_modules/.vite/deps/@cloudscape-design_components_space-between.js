...
import "/local/home/samilafo/final_epa_project/QwizGuruPlatform/cloudscape/node_modules/@cloudscape-design/components/space-between/styles.scoped.css";
...
function InternalSpaceBetween(_a) {
  ...
  return import_react.default.createElement("div", __assign({}, baseProps, { className: clsx_m_default(baseProps.className, styles_css_default.root, styles_css_default[direction], styles_css_default["".concat(direction, "-").concat(size)]), ref: __internalRootRef }), flattenedChildren.map(function(child) {
    var key = child.key;
    return import_react.default.createElement("div", { key, className: clsx_m_default(styles_css_default.child, styles_css_default["child-".concat(direction, "-").concat(size)]) }, child);
  }));
}
...
function SpaceBetween(_a) {
  ...
  return import_react2.default.createElement(InternalSpaceBetween, __assign({ direction }, props, baseComponentProps));
}
