...
function Background() {
  var _a, _b;
  var _c = (0, import_react14.useContext)(AppLayoutContext), hasNotificationsContent = _c.hasNotificationsContent, hasStickyBackground = _c.hasStickyBackground, stickyNotifications = _c.stickyNotifications;
...
function Header() {
  var _a;
  var _b = (0, import_react15.useContext)(AppLayoutContext), breadcrumbs = _b.breadcrumbs, contentHeader = _b.contentHeader, hasNotificationsContent = _b.hasNotificationsContent;
  if (!contentHeader) {
    return null;
  }
...
function Notifications2() {
  var _a;
  var _b;
  var _c = (0, import_react20.useContext)(AppLayoutContext), ariaLabels = _c.ariaLabels, hasNotificationsContent = _c.hasNotificationsContent, notifications = _c.notifications, notificationsElement = _c.notificationsElement, stickyNotifications = _c.stickyNotifications;
  if (!notifications) {
    return null;
  }
...
var AppLayoutWithRef = import_react22.default.forwardRef(function AppLayout(props, ref) {
  var isMobile = (0, import_react22.useContext)(AppLayoutContext).isMobile;
          ...
          import_react23.default.createElement(
            ...
            import_react23.default.createElement(
              ...
              import_react23.default.createElement(
                ...
                import_react23.default.createElement(AppLayoutContext2.Provider, { value: {
