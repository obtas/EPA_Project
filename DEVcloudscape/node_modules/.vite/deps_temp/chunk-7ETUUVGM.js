...
function Transition2(_a) {
  ...
  var transitionRootElement = (0, import_react9.useRef)(null);
  var _e = (0, import_react8.useState)(isIn ? "entered" : "exited"), transitionState = _e[0], setTransitionState = _e[1];
  var motionDisabled = useReducedMotion(transitionRootElement) || disabled;
  var addTransitionEndListener = (0, import_react9.useCallback)(function(done) {
  ...
  return import_react8.default.createElement(Transition_default, __assign({ addEndListener: addTransitionEndListener, timeout: motionDisabled ? 0 : void 0, "in": isIn, nodeRef: transitionRootElement, exit, onEnter: function(isAppearing) {
    if (!isAppearing) {
...
//# sourceMappingURL=chunk-7ETUUVGM.js.map
