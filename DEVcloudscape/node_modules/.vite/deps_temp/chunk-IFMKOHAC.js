...
function useSplitPanelContext() {
  return (0, import_react2.useContext)(SplitPanelContext);
}

// node_modules/@cloudscape-design/components/app-layout/visual-refresh/styles.css.js
import "/local/home/samilafo/final_epa_project/QwizGuruPlatform/DEVcloudscape/node_modules/@cloudscape-design/components/app-layout/visual-refresh/styles.scoped.css";
...
function SplitPanel(_a) {
  ...
  var splitPanelRef = (0, import_react4.useRef)(null);
  var splitPanelHeaderRef = (0, import_react4.useRef)(null);
  var context = {
    bottomOffset: 0,
    getMaxHeight: function() {
  ...
  return import_react4.default.createElement(SplitPanelContext.Provider, { value: __assign({}, context) }, children);
}
function SplitPanelBottom() {
  var _a = (0, import_react4.useContext)(AppLayoutContext), disableBodyScroll = _a.disableBodyScroll, isNavigationOpen = _a.isNavigationOpen, isSplitPanelOpen = _a.isSplitPanelOpen, isToolsOpen = _a.isToolsOpen, splitPanel = _a.splitPanel, splitPanelReportedSize = _a.splitPanelReportedSize;
  var _b = (0, import_react4.useContext)(SplitPanelContext), splitPanelPosition = _b.position, getHeader = _b.getHeader;
  var headerHeight = useObservedElement(getHeader);
  if (!splitPanel) {
    return null;
  }
  return import_react4.default.createElement(Transition, { "in": isSplitPanelOpen !== null && isSplitPanelOpen !== void 0 ? isSplitPanelOpen : false, exit: false }, function(state, transitionEventsRef) {
    var _a2, _b2;
    return import_react4.default.createElement(
      ...
      import_react4.default.createElement(SplitPanel, null),
      splitPanelPosition === "bottom" && splitPanel
    );
  });
}
function SplitPanelSide() {
  var _a = (0, import_react4.useContext)(AppLayoutContext), isSplitPanelOpen = _a.isSplitPanelOpen, splitPanel = _a.splitPanel, splitPanelMaxWidth = _a.splitPanelMaxWidth, splitPanelMinWidth = _a.splitPanelMinWidth, splitPanelReportedSize = _a.splitPanelReportedSize;
  var splitPanelPosition = (0, import_react4.useContext)(SplitPanelContext).position;
  if (!splitPanel) {
    return null;
  }
  return import_react4.default.createElement(Transition, { "in": isSplitPanelOpen !== null && isSplitPanelOpen !== void 0 ? isSplitPanelOpen : false, exit: false }, function(state, transitionEventsRef) {
    ...
    return import_react4.default.createElement(
      ...
      import_react4.default.createElement("div", { className: clsx_m_default(styles_css_default["animated-content"]) }, splitPanelPosition === "side" && splitPanel)
    );
  });
}
...
var defaults2 = {
  ...
  isToolsOpen: false,
  layoutElement: (0, import_react5.createRef)(),
  layoutWidth: 0,
  mainElement: (0, import_react5.createRef)(),
  mainOffsetLeft: 0,
  maxContentWidth: 0,
  minContentWidth: 280,
  navigation: null,
  ...
  navigationOpen: false,
  notifications: null,
  notificationsElement: (0, import_react5.createRef)(),
...
var AppLayoutContext = (0, import_react5.createContext)(__assign({}, defaults2));
var AppLayoutProvider = import_react5.default.forwardRef(function(_a, forwardRef) {
  var _b, _c, _d;
  ...
  var _h = (0, import_react5.useState)(0), dynamicOverlapHeight = _h[0], setDynamicOverlapHeight = _h[1];
  var _j = (0, import_react5.useState)(false), hasStickyBackground = _j[0], setHasStickyBackground = _j[1];
  ...
  var handleNavigationClick = (0, import_react5.useCallback)(function handleNavigationChange(isOpen) {
  ...
  var handleToolsClick = (0, import_react5.useCallback)(function handleToolsChange(isOpen) {
  ...
  (0, import_react5.useEffect)(function handleBodyScroll() {
  ...
  (0, import_react5.useImperativeHandle)(forwardRef, function createImperativeHandle() {
    return {
  ...
  var _p = (0, import_react5.useState)(0), headerHeight = _p[0], setHeaderHeight = _p[1];
  var getHeader = (0, import_react5.useCallback)(function() {
  ...
  var _q = (0, import_react5.useState)(0), footerHeight = _q[0], setFooterHeight = _q[1];
  var getFooter = (0, import_react5.useCallback)(function() {
  ...
  var _r = (0, import_react5.useState)(splitPanelMinWidth), splitPanelMaxWidth = _r[0], setSplitPanelMaxWidth = _r[1];
  ...
  var handleSplitPanelClick = (0, import_react5.useCallback)(function handleSplitPanelChange() {
  ...
  var _u = (0, import_react5.useState)(false), isSplitPanelForcedPosition = _u[0], setSplitPanelForcedPosition = _u[1];
  var splitPanelPosition = getSplitPanelPosition(isSplitPanelForcedPosition, splitPanelPreferences);
  (0, import_react5.useLayoutEffect)(function handleSplitPanelForcePosition() {
    setSplitPanelForcedPosition(splitPanelMinWidth > splitPanelMaxWidth);
  }, [splitPanelMaxWidth, splitPanelMinWidth]);
  var _v = (0, import_react5.useState)(0), splitPanelReportedSize = _v[0], setSplitPanelReportedSize = _v[1];
  ...
  var handleSplitPanelResize = (0, import_react5.useCallback)(function handleSplitPanelChange(detail) {
  ...
  var handleSplitPanelPreferencesChange = (0, import_react5.useCallback)(function handleSplitPanelChange(detail) {
  ...
  var mainElement = (0, import_react5.useRef)(null);
  var _y = (0, import_react5.useState)(0), mainOffsetLeft = _y[0], setMainOffsetLeft = _y[1];
  (0, import_react5.useLayoutEffect)(function handleMainOffsetLeft() {
    var _a2, _b2;
  ...
  (0, import_react5.useLayoutEffect)(function handleSplitPanelMaxWidth() {
  ...
  var _0 = (0, import_react5.useState)(0), notificationsHeight = _0[0], setNotificationsHeight = _0[1];
  var _1 = (0, import_react5.useState)(false), hasNotificationsContent = _1[0], setHasNotificationsContent = _1[1];
  (0, import_react5.useEffect)(function handleNotificationsContent() {
  ...
  var _2 = (0, import_react5.useState)(0), offsetBottom = _2[0], setOffsetBottom = _2[1];
...
//# sourceMappingURL=chunk-IFMKOHAC.js.map
