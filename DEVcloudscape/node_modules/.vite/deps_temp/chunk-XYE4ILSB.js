...
import "/local/home/samilafo/final_epa_project/QwizGuruPlatform/DEVcloudscape/node_modules/@cloudscape-design/components/icon/styles.scoped.css";
...
var InternalIcon = function(_a) {
  ...
  var iconRef = (0, import_react.useRef)(null);
  useVisualRefresh();
  var _e = (0, import_react.useState)(null), parentHeight = _e[0], setParentHeight = _e[1];
  ...
  if (svg) {
    ...
    return import_react.default.createElement("span", __assign({}, baseProps, { ref: mergedRef, "aria-hidden": "true", style: inlineStyles }), svg);
  }
  if (url) {
  ...
  return import_react.default.createElement("span", __assign({}, baseProps, {
...
//# sourceMappingURL=chunk-XYE4ILSB.js.map
