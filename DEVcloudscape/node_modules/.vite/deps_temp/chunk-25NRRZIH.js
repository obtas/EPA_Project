...
import "/local/home/samilafo/final_epa_project/QwizGuruPlatform/DEVcloudscape/node_modules/@cloudscape-design/components/box/styles.scoped.css";
...
function InternalBox(_a) {
  ...
  var className = clsx_m_default(baseProps.className, styles_css_default.root, styles_css_default.box, styles_css_default["".concat(variant.replace(/^awsui-/, ""), "-variant")], marginsClassNamesSuffices.map(function(suffix) {
    return styles_css_default["m-".concat(suffix)];
  }), paddingsClassNamesSuffices.map(function(suffix) {
    return styles_css_default["p-".concat(suffix)];
  }), styles_css_default["d-".concat(display)], styles_css_default["f-".concat(float)], styles_css_default["color-".concat(color || "default")], styles_css_default["font-size-".concat(fontSize || "default")], styles_css_default["font-weight-".concat(fontWeight || "default")], styles_css_default["t-".concat(textAlign)]);
  return import_react.default.createElement(Tag, __assign({}, baseProps, { className, ref: __internalRootRef }), children);
}
...
//# sourceMappingURL=chunk-25NRRZIH.js.map
