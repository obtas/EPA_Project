...
export declare type ExtendedOperator<TokenValue> = PropertyFilterOperatorExtended<TokenValue>;
export declare type ExtendedOperatorFormProps<TokenValue> = PropertyFilterOperatorFormProps<TokenValue>;
export declare type ExtendedOperatorForm<TokenValue> = PropertyFilterOperatorForm<TokenValue>;
export declare type ExtendedOperatorFormat<TokenValue> = PropertyFilterOperatorFormat<TokenValue>;
